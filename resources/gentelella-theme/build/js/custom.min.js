...
function init_flot_chart()
{
	...
	today = mm + '/' + dd + '/' + yyyy;
	var tglStart = moment().subtract(29, "days");
	var tglEnd = moment();
	if (funTglStart() != 0){
		tglStart = funTglStart();
		tglEnd = funTglEnd();	
	}
	...
	if ("undefined" != typeof $.fn.daterangepicker)
	{
		...
		$("#reportrange span").html(moment(tglStart).format("DD MMMM YYYY") + " - " + moment(tglEnd).format("DD MMMM YYYY")), $("#reportrange").daterangepicker(b, a), $("#reportrange").on("show.daterangepicker", function ()
		{
