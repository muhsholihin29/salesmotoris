...
function init_flot_chart()
{
	...
	function init_daterangepicker()
	{
		...
		var dtStart = url.substring(url.lastIndexOf('date_start=') + 19);
		var dtEnd = url.substring(url.lastIndexOf('date_end=') + 17);

		var mStartDate = dtStart.substring(0, 2);
		var mEndDate = dtEnd.substring(0, 2);
	...
	today = mm + '/' + dd + '/' + yyyy;
	if (parseInt(mStartDate) > 0 && parseInt(mStartDate) <= 31) {
		var tglStart = new Date(m+1 +'-'+ mStartDate +'-'+ yyyy);
	}else{
		var tglStart = new Date(m+1 +'-01-'+ yyyy);	
	}
	
	if (parseInt(mEndDate) > 0 && parseInt(mEndDate) <= 31) {
		var tglEnd = new Date(m+1 +'-'+ mEndDate +'-'+ yyyy);
	}else{
		var tglEnd = moment();
	}
	...
	function prepareDate(d) {
  	...
  	if ("undefined" != typeof $.fn.daterangepicker)
  	{
  		...
  		{
  			tgl(a.format("DD-MM-YYYY"),b.format("DD-MM-YYYY"));
  			console.log("cek moment" + moment().subtract(29, "days"));
  			console.log(a.toISOString(), b.toISOString(), c), $("#reportrange span").html(a.format("DD MMMM YYYY") + " - " + b.format("DD MMMM YYYY"))

			// Create a form
			var mapForm = document.createElement("form");
			mapForm.target = "_top";    
			mapForm.method = "GET";
			mapForm.action = document.URL;

			var mapInput = document.createElement("input");
			mapInput.type = "text";
			mapInput.name = "date_start";
			mapInput.value = a.format("YYYY-MM-DD");

			mapForm.appendChild(mapInput);

			var mapInput = document.createElement("input");
			mapInput.type = "text";
			mapInput.name = "date_end";
			mapInput.value = b.format("YYYY-MM-DD");
		...
		{
			console.log("apply event fired, start/end dates are " + b.startDate.format("DD MMMM YYYY") + " to " + b.endDate.format("DD MMMM YYYY"))
...
function init_daterangepicker_right()
{
	if ("undefined" != typeof $.fn.daterangepicker)
	{
		...
		var a = function (a, b, c)
		{
			console.log(a.toISOString(), b.toISOString(), c), $("#reportrange_right span").html(a.format("DD MMMM YYYY") + " - " + b.format("DD MMMM YYYY"))
		},
		b = {
		...
		$("#reportrange_right span").html(moment().subtract(29, "days").format("DD MMMM YYYY") + " - " + moment().format("DD MMMM YYYY")), $("#reportrange_right").daterangepicker(b, a), $("#reportrange_right").on("show.daterangepicker", function ()
		{
			console.log("show event fired")
