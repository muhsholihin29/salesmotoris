        ...
        <table class="table table-bordered table-striped" id="mytable">
          <thead>
            <tr><th width="80px"><center>No<center></th>
              ...
              <th width="130px"><center>Senin</center></th>
              <th width="130px"><center>Selasa</center></th>
              <th width="130px"><center>Rabu</center></th>
              <th width="130px"><center>Kamis</center></th>
              <th width="130px"><center>Jumat</center></th>
              <th width="130px"><center>Aksi</center></th>
            </tr>
          </thead>

          @foreach ($data['user'] as $key=>$visit)
          <tr>
            ...
            <td><center>toko</center></td>
            <td>
                <button type="button" class="btn transparent btn-green" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target=".modal-confi" onclick="return edit('{{$visit->id}}');">Ubah</button>
            </td>
          </tr>
          @endforeach
        </table>
